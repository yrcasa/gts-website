...
<body>
  ...
  <main id="main">
    <section class="partner" style="padding-top: 50px !important;">
      ...
      <iframe id="JotFormIFrame-231648922077058" title="Become A Partner" onload="window.parent.scrollTo(0,0)" allowtransparency="true" allowfullscreen="true" allow="geolocation; microphone; camera" src="https://form.jotform.com/231648922077058" frameborder="0" style="min-width:100%;max-width:100%;height:539px;border:none;" scrolling="no">
      </iframe>
      <script type="text/javascript">
        var ifr = document.getElementById("JotFormIFrame-231648922077058");
        if (ifr) {
          var src = ifr.src;
          var iframeParams = [];
