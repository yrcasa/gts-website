	...
	<ul>
		...
		<li class="drop-down"><a href="https://globaltigersolutions.com/partner.php">Our Solutions</a>
			<ul class="nav-solutions" style="width: 180px;">
				<li><a href="endpoint.php">Endpoint Protection and CyberSecurity</a></li>
				<li><a href="networkSecurity.php">Network Security and Firewall</a></li>
				<li><a href="privilegedAccess.php">Privileged Access Management</a></li>
		...
		<li class="drop-down"><a href="../contact.php">Contact Us</a>
			<ul>
				...
				<li><a href="../contact.php">Become a Partner</a></li>
			</ul>
		</li>
	</ul>
</nav><!-- .nav-menu -->