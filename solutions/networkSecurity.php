...
<head>
	...
	<meta name="keywords" content="network security, network security global tiger solutions, firewall, network security and firewall, tcsdi firewall, cybersecurity">
	<title>Network Security and Firewall | Global Tiger Solutions</title> <?php include "../links.php" ?>
		...
		<section class="partner" style="padding-top: 100px !important;">
			<div class="container">
				<div class="section-title" data-aos="zoom-out">
					<p>Solutions</p>
					<h2>Network Security and Firewall</h2>
				</div>
