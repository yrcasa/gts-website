...
<head>
    ...
    <meta name="keywords" content="newsroom tcsdi, newsroom tiger, tcsdi newsroom, tiger newsroom, newsroom tiger consulting, tiger consulting newsroom">
    <title>Newsroom | Global Tiger Solutions</title>
    ...
    <!-- ======= Partner  Section ======= -->
          ...
          <div class="container">
            ...
            <div class="section-title" data-aos="zoom-out">
              <h2>Newsroom</h2>
              <p>Catch-up for latest news & trends</p>
            </div>
            ...
            <div class="content">
                 <!-- Articles will be here -->
                  ...
                  <a id="button_prev" class="btn-learn-more">
                    <i class="icofont-arrow-left"></i>
                    Previous
                  </a>
                  <a id="button_next" class="btn-learn-more">
                    Next
...
<!-- 
            <a class="btn btn-default" id="button_prev"><- Previous</a>
            <a class="btn btn-default" id="button_next">Next -></a> -->    
