<?php include "../../contactDetails.php"; ?> <!-- ======= Footer ======= -->
<footer id="footer">
	<div class="container-fluid">
      ...
      <p>We at GTS working to provide innovative, reliable and secured IT Solutions.<p> -->
			...
			<div class="col-md-3 mx-auto">
				...
				<ul class="list-unstyled text-lg-left">
					...
					<li>
						...
						<a href="tel:<?php echo $directContact; ?>" target="_blank"> Phone: <?php echo $directContact; ?> </a>
					</li>
					<li>
		...
		<div class="credits">
			...
			<!-- Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/selecao-bootstrap-template/ --> Copyright © 2023. All Rights Reserved. Powered by Global Tiger Solutions.
		</div>
	</div>
</footer>
<!-- End Footer -->