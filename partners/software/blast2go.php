...
<head>
  ...
  <meta name="Description" content="Tiger Consulting is a CERTIFIED partner and reseller of Blast2Go.">
  <meta name="keywords" content="blast2go, blast2go software, tcsdi blast2go software, tiger blast2go software, tiger consulting blast2go software, blast2go certified partner, certified partner blast2go, certified partner of blast2go, authorized reseller blast2go, authorized reseller of blast2go, authorized re-seller blast2go, authorized re-seller of blast2go, blast2go authorized reseller, blast2go authorized re-seller">
  <title>Products - Blast2Go | Global Tiger Solutions</title>
  <!-- Favicons -->
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-md-6 col-sm-12">
            <img src="../../assets/img/productpagebanner/blast2go/blast2go_prodbanner.png" width="80%">
            <br>
            <h4><strong>Products:</strong></h4>
            <ul>
              <li><i class="ri-check-double-line"></i>Blast2Go Pro</li>
              <li><i class="ri-check-double-line"></i>Blast2Go Basic</li>
            </ul>
          </div>
          <div class="col-md-6 col-sm-12">
            <h1> BLAST2GO </h1>
            <p> Blast2GO is a bioinformatics platform for the functional analysis of genomic datasets. It allows analyzing and visualizing newly sequenced genomes by combining state-of-the-art methodologies, standard resources and algorithms. Blast2GO allows to gain biological insights fast and easy - even for completely novel genomes. </p>
            <p> Global Tiger Solutions is a CERTIFIED partner and reseller of Blast2Go. </p>
