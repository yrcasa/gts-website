        ...
        <div class="row content">
          <div class="col-md-6 col-sm-12">
            ...
            <ul>
              ...
              <li><i class="ri-check-double-line"></i>Visual Paradigm Standard Edition</li>
              <li><i class="ri-check-double-line"></i>Visual Paradigm Modeler Edition</li>
              <li><i class="ri-check-double-line"></i>Visual Paradigm Community Edition</li>
            </ul>
          </div>
          <div class="col-md-6 col-sm-12">
