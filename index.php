...
<head>
  ...
  <meta name="keywords" content="tcsdi, global tiger solutions, internet security, antivirus distributor, endpoint protection, flight information display, fids, foxit, anydesk, bullguard, heimdal, Cybersecurity">



  <!-- Keywords Used: 2,3,4,5,12,13,14,17,23,24 -->
...
<body>
        ...
        <div class="carousel-item active">
          ...
          <div class="carousel-container">
            ...
            <p class="animated fadeInUp">
              ...
              WatchGuard Endpoint Security features the Panda Security technology you know and love, including a full stack of integrated product options with encryption, patching, remote monitoring and management, and more.
  ...
  <?php include('companySlider.php') ?>



  <!-- End Company Slider Section -->
  ...
  <?php include "productHighlights.php" ?>
